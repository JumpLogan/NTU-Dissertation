/** Modulation Parameters
	!!! Automatically Generated from gen_parameters.m matlab file !!!
**/

#ifndef MODULATION_PARAMETERS_H
#define MODULATION_PARAMETERS_H
...
#define QUAR_BUFF_SIZE  250    /* Quarter of the message buffer*/
#define NUM_SAMPLES     16     /* The number of samples*/
#define SAMPLE_RANGE    16000   /* The size of modulated signal*/
